...
import fusheng.runner.exception.ExecutorException;
...
public class Executor {
    ...
    public StdEnvironment.Context exec(Map<String, Object> symbols, String jsCode) {
        symbols.forEach(engine::put);

        try {
            engine.eval(jsCode);
            return StdEnvironment.Context.of(engine.getBindings(ScriptContext.ENGINE_SCOPE));
